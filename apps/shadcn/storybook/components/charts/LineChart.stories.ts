...
import { LineChart, type LineChartProps } from '@/06-shared'
...
const meta = {
  ...
  argTypes: {
    curveType: {
      ...
      options: Object.values(CurveType) as Array<LineChartProps<Data>['curveType']>
    }
  },
  args: {
    data: [
...
} satisfies Meta<typeof LineChart<Data>>
